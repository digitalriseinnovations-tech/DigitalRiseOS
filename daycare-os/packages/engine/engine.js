// @ts-nocheck
/* Ported 1:1 from website/agents/shared/agents-actions.js.
   DRS (storage adapter) and DRD (catalog) are injected — the body is unchanged. */
export function createEngine(DRS, DRD) {
